    ...
    return (
        <Card className="w-full">
            <CardHeader className='flex flex-row items-center justify-between mb-3'>
                <CardTitle className="text-2xl font-bold">Información de los participantes</CardTitle>
                <FormDocenteDialog
                    textButtonTrigger='Agregar nuevo participante'
                    textButtonSubmit='Agregar participante'
                    title='Formulario registro participante'
                    description='Ingresa cada uno de los campos para registrar un nuevo participante'
                />
            </CardHeader>
            <CardContent>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead>
                                        <Button variant="ghost" onClick={() => handleSort('academicProgram')} className="font-bold pl-0">
                                            Programa académico
                                            {sortField === 'academicProgram' && (
                                                sortDirection === 'asc' ? <ChevronUp className="ml-2 h-4 w-4 inline" /> : <ChevronDown className="ml-2 h-4 w-4 inline" />
                                            )}
                                        </Button>
                                    </TableHead>
                            ...
                            <TableBody>
                                {filteredAndSortedUsers.map((user) => (
                                    <TableRow key={user.id} className="transition-colors hover:bg-muted/50">
                                        ...
                                        <TableCell>{user.academicProgram}</TableCell>
                                        <TableCell>
                                            {user.isActive ? (
                                        ...
                                        <TableCell>
                                            <Button
                                                ...
                                                className="font-bold transition-all duration-200 ease-in-out transform hover:scale-105"
                                            >
