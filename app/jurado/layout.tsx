...
type SeccionesKeys = "inicio" | "informacion-personal" | "proyectos";
...
export default function JuradoLayout({ children }: Readonly<{ children: React.ReactNode }>) {
                ...
                <div className="flex h-full max-h-screen flex-col gap-2">
                    <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
                        <Link href="/" className="flex items-center gap-2 font-semibold">
                            ...
                            <span className="text-white">Jurado</span>
                        </Link>
                    </div>
                                                ...
                                                <div className="pl-4">
                                                    {itemsMenu[sectionKey].subitems.map((subitem: any, index: number) => (
                                                        <Link
                                                            ...
                                                            href={`/jurado/proyectos/${subitem.name}`}
